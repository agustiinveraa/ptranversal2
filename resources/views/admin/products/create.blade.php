...
<div class="container py-5">
    <div class="text-center mb-5">
        ...
        <h2 class="text-4xl font-bold text-indigo-700">Nou producte</h2>
    </div>
            ...
            <form action="{{ route('admin.products.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('subcategory_id') is-invalid @enderror" id="subcategory_id" name="subcategory_id" required>
                        ...
                        <option value="{{ $subcategory->id }}" {{ old('subcategory_id') == $subcategory->id ? 'selected' : '' }}>{{ $subcategory->name }} ({{ $subcategory->category->name }})</option>
                        @endforeach
                    </select>
